...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    @Transactional
    public UserDetails loadUserByUsernameAndTenantId(String username, Long tenantId) throws UsernameNotFoundException {
        User user = userRepository.findByUsernameAndTenantId(username, tenantId)
                .orElseThrow(() -> new UsernameNotFoundException(
                        "User not found with username: " + username + " and tenantId: " + tenantId));
